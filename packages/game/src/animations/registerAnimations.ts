...
export function registerAnimations(scene: Phaser.Scene): void {
  ...
  create(ANIM_KEY.PIG_BOX_IDLE, TEXTURE_KEY.PIG_BOX_IDLE, PIG_BOX_FRAMES.IDLE, ANIM.IDLE_FPS, true)
  create(ANIM_KEY.PIG_BOX_RUN, TEXTURE_KEY.PIG_BOX_RUN, PIG_BOX_FRAMES.RUN, ANIM.RUN_FPS, true)
  create(ANIM_KEY.PIG_BOX_PICK, TEXTURE_KEY.PIG_BOX_PICK, PIG_BOX_FRAMES.PICK, ANIM.ATTACK_FPS, false)
  create(ANIM_KEY.PIG_BOX_THROW, TEXTURE_KEY.PIG_BOX_THROW, PIG_BOX_FRAMES.THROW, ANIM.ATTACK_FPS, false)
